                        ...
                        <div class="card card-primary border-box">
                            ...
                            <div class="card-body card-body-auth">
                                <form method="POST" action="{{ route('admin_reset_password_submit') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control @error('retype_passsword') is-invalid @enderror" name="retype_passsword" placeholder="Retype Password">
                                        @error('retype_passsword') 
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror  
                                    </div>
                                    <div class="form-group">
